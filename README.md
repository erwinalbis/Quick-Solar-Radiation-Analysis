...
[Step 4 Set-up Genetic algorithm. Use Galapagos component. For elevation, use Rotate component, with slider 0-360degree rotations (Slider 0-360). Link to Genome: Rotation(elevation), Twist, and Fitness to Mass Addition results.
for twist download Twisted Geometry by Danny Boyes. Link Case study model to Brep to Twist.]
[Step 5 To run the script, set LB FalseStart Toggle to True.]
